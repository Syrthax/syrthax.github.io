  ...
  return (
    <section id="home" ref={ref} className="section-shell relative min-h-screen py-24">
      <motion.div style={{ y, opacity }} className="grid min-h-[80vh] items-center gap-12 lg:grid-cols-2">
        <div>
          <p className="eyebrow">KrispLabs</p>
          <h1 className="headline mt-4">Small, sharp software.</h1>
          <p className="subtle mt-5 max-w-xl">
            KrispLabs is the studio behind Kiosk, iDo, Kiosk Scholar, NutriScan, and Soura — local-first tools
            built by Sarthak Ghosh in Hyderabad, India.
          </p>
...
export function FeaturedFlagshipsSection() {
  return (
    <section className="section-shell space-y-24 py-28 md:py-36">
      <Reveal>
        <h2 className="headline">Flagships</h2>
        <p className="subtle mt-4 max-w-2xl">The work we point to first.</p>
      </Reveal>
      ...
      <Reveal className="grid items-center gap-12 overflow-hidden rounded-3xl border border-neutral-300/60 p-8 md:grid-cols-[1fr_minmax(320px,420px)] md:p-12 dark:border-neutral-800">
        <div>
          ...
          >
            Open Kiosk <span aria-hidden="true">→</span>
          </a>
        </div>
      ...
      <Reveal className="grid gap-12 rounded-3xl border border-neutral-300/60 p-8 md:grid-cols-2 md:p-12 dark:border-neutral-800">
        <div>
          ...
          <p className="subtle mt-4">
            iDo is a lightweight productivity system that syncs tasks using your own Google Drive instead of
            centralized servers.
          </p>
          <ul className="mt-6 space-y-2 text-sm text-muted">
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-1 text-sm font-medium text-neutral-600 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100"
          >
            Open iDo <span aria-hidden="true">→</span>
          </a>
        </div>
        <TaskSyncIllustration />
      </Reveal>
  ...
  return (
    <section id="projects" className="section-shell py-28 md:py-36">
      <Reveal>
        ...
        <p className="subtle mt-4 max-w-2xl">Everything KrispLabs has shipped so far.</p>
      </Reveal>
          ...
          >
            ...
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="rounded-full border border-neutral-300 px-2 py-0.5 text-[10px] uppercase tracking-[0.2em] text-muted dark:border-neutral-700">
                  {project.tagline}
                </span>
                {project.deprecated && (
              ...
              <ul className="mt-4 flex flex-wrap gap-2">
                {project.highlights.map((h) => (
                  <li
                    key={h}
                    className="rounded-md border border-neutral-200/70 bg-neutral-50 px-2.5 py-1 text-xs text-neutral-700 dark:border-neutral-700 dark:bg-neutral-900/70 dark:text-neutral-300"
                  >
                    {h}
                  </li>
                ))}
  ...
  return (
    <section className="section-shell py-28 md:py-36">
      <Reveal>
        ...
        <h2 className="headline mt-4">Three things we don&apos;t compromise on.</h2>
      </Reveal>
      ...
      <div className="mt-14 grid gap-6 md:grid-cols-3">
        {focusAreas.map((area, index) => (
          ...
          >
            ...
            <p className="subtle mt-3 text-base">{area.body}</p>
          </Reveal>
        ))}
      </div>
    </section>
...
export function TechStackSection() {
  ...
  return (
    <section className="section-shell py-28 md:py-36">
      <Reveal>
        <h2 className="headline">The stack behind the labs</h2>
      </Reveal>
    ...
    <section className="section-shell py-28 md:py-36">
      <Reveal>
        ...
        <p className="mt-6 max-w-4xl text-3xl font-medium leading-tight tracking-tight md:text-5xl">
          We build tools that are simple, fast, and useful in everyday life.
        </p>
      </Reveal>
    </section>
  );
...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="section-shell pb-40 pt-24 md:pt-28">
      <Reveal>
        <h2 className="headline max-w-2xl">Work with KrispLabs.</h2>
        <p className="subtle mt-4 max-w-xl">
          Got an idea for a small, sharp tool? Or want to use one of ours? Reach out.
        </p>
      </Reveal>
